// ============================================================================
// UE5_Multi_Shooter/System/MosesLobbyLocalPlayerSubsystem.h  (FULL - REORDERED)
// ============================================================================
 ...
 * - SSOT(GameState/PlayerState) 변화 -> 위젯 갱신(Delegate 파이프)
 *
 * [SSOT]
 * - 룸/Ready/채팅 등: AMosesLobbyGameState (rep)
 * - 내 상태/선택 캐릭터/로그인: AMosesPlayerState (rep)
 */
UCLASS(Config = Game)
...
public:
	...
	void NotifyLobbyNicknameChanged(const FString& NewNickname); // RepNotify -> Subsys -> Widget refresh
